...
`,
  ...
  return {
    ...
    featureClass,
    planId,
    metadata: { modId, pkg, mcVersion, neoForgeVersion, createVersion, aeronauticsModId, loader, useCreate, useAeronautics },
  };
}
...
app.post("/api/create-project", (req, res) => {
  ...
  try {
    ...
    appendAudit("project_created", { root, modId, loader, useCreate, useAeronautics });
    return res.json({
      ok: true,
      projectPath: root,
      projectKey,
      project: { modId, pkg, loader, useCreate, useAeronautics, mcVersion, neoForgeVersion, createVersion },
    });
  } catch (error) {
